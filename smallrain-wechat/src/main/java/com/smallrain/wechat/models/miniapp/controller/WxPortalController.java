...
public class WxPortalController {
  ...
  public String post(@PathVariable String appid, @RequestBody String requestBody,
      ...
      @RequestParam(name = "signature", required = false) String signature, @RequestParam("timestamp") String timestamp,
  ...
  private void route(WxMaMessage message, String appid) {
    try {
      WechatMiniAppConfiguration.getRouter(appid).route(message);
    } catch (Exception e) {
